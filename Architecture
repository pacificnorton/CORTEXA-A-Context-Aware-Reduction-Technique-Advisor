...
![Global Architecture](../images/Architecture.jpeg)
...
The User Interaction layer provides access to CORTEXA’s recommendation workflow through a graphical interface. Users specify the dataset context and rank the recommendations, as shown in Figure~\ref{fig:input2}, and the system returns a ranked list of reduction methods with concise visual and textual explanations directly linked to the inputs and learned behavioural profiles.
